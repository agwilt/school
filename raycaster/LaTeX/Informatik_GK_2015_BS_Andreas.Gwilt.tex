...
Weil es passieren kann, dass der erste Punkt V schon außerhalb des Spielfeldes ist, ist diese ganze Überprüfung in einem \texttt{try} gepackt. Wenn ein \texttt{IndexError} auftritt, \texttt{break}ed es wieder die Schleife und geht weiter zu den horizontalen Überprüfungen. \\
